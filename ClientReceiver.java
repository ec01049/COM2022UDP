...
public class ClientReceiver {
    ...
    public void keepListening() throws Exception {
        ...
        try {
            ...
            if(incomingType.equals("message")){
                ...
                PrivateKey privateKey = (PrivateKey) ClientReceiver.keyPair.get("private");
    ...
    private static String getPem() throws IOException {
        var keys = ClientReceiver.keyPair == null ? getRSAKeys() : ClientReceiver.keyPair;
        ClientReceiver.keyPair = keys;
